...
photo_info <- read_sheet("https://docs.google.com/spreadsheets/d/10pwVATuDKQDj7_X67Bc_EDO5Wm6wgVvCG8N7fIiC2Y4/edit?usp=sharing",
           sheet = "photos",
           col_types = "c")
photo_info %>% 
  write_csv(here("static", "manuscripts", "photo_list.csv"))
```
