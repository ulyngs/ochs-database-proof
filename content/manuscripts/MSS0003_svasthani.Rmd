...
photos_folder <- here("static", "manuscripts", "images", "MSS0003_svasthani")

photo_info <- tibble(
   photoid = list.files(photos_folder),
   zoomid = str_c("result", photoid),
   photo_path = str_c("/manuscripts/images/MSS0003_svasthani/", list.files(photos_folder))
)
