---
title: MSS0001 Durgāsaptaśatī (Caṇḍīpāṭha)
sanskritTitle: हठप्द
transliteratedTitle: Durgāsaptaśatī (Caṇḍīpāṭha)
englishTitle: Durgāsaptaśatī (Caṇḍīpāṭha)
...
photos_folder <- here("static", "manuscripts", "images", "MSS0001JPG")

photo_info <- tibble(
   photoid = list.files(photos_folder),
   zoomid = str_c("result", photoid),
   photo_path = str_c("/manuscripts/images/MSS0001JPG/", list.files(photos_folder))
)
...
create_content <- function(photoid, zoomid, photo_path) {
   ...
   cat('<div class="col-sm-6">')
   cat('<h2>No text available yet. Contribute by going to **this google sheet**.</h2>')
   cat("</div>") # close column
