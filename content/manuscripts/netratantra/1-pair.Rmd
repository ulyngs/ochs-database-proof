...
hasPhotos: yes
hasText: yes
photoPathMedium: https://shakta-manuscripts.s3.eu-west-2.amazonaws.com/netratantra/medium_resolution/DOC__000.JPG
photoSizeMedium: 536.4 KB
photoPathHigh: https://shakta-manuscripts.s3.eu-west-2.amazonaws.com/netratantra/high_resolution/DOC__000.JPG
photoSizeHigh: 10.6 MB
imagesTotal: 89
imageCurrent: 1
numImagesView: pair
categories:
...
end_slice <- ifelse(params$currentImage < params$totalImages, params$currentImage + 1, params$currentImage)
...
photo_info <- tibble(
   ...
   slice(params$currentImage:end_slice)
